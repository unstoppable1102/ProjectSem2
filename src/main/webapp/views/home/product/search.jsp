                            ...
                            <ul class="pagination">
                                <c:choose>
                                    <c:when test="${not products.first}">
                                        <li class="page-item">
                                            <a class="page-link" href="?page=${products.number - 1}&size=${products.size}&sort=${sort}&keyword=${keyword}">
                            ...
                            <span class="page-link">
                                ...
                                <c:forEach begin="0" end="${products.totalPages - 1}" step="1" varStatus="status">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=${status.index}&size=${products.size}&sort=${sort}&keyword=${keyword}">
                                                        ${status.index + 1}
                                                </a>
                                            </li>
                                        </c:otherwise>

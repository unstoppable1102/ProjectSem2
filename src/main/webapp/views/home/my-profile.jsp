            ...
            <div class="row">
              <div class="col-lg-2">
                <div class="profile-image">
                  <a href="#">
                    <img src="${contextPath}/resources/images/${sessionScope.avatar}" alt="user" width="150px">
                  </a>
                </div>
                </div>
              </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content"><button class="modal-close" data-bs-dismiss="modal"><i
      ...
      <form class="modal-form">
        ...
        <div class="form-group"><label class="form-label">name</label>
          <input class="form-control" type="text" value="${sessionScope.fullName}"></div>
        <div class="form-group"><label class="form-label">email</label>
          <input class="form-control" type="text" value="${sessionScope.email}"></div>
        <button class="form-btn" type="submit">save
        profile info</button>
      </form>
    </div>
  </div>

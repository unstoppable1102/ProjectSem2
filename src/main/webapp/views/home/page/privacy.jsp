...
<section class="inner-section privacy-part">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <nav class="nav nav-pills flex-column" id="scrollspy"><a class="nav-link" href="#item-1">How to
                    contact with Customer Service?</a><a class="nav-link" href="#item-2">App installation
                    failed, how to update system information?</a><a class="nav-link" href="#item-3">Website
                    reponse taking time, how to improve?</a><a class="nav-link" href="#item-4">How do I create a
                    account?</a><a class="nav-link" href="#item-5">I cannot find an answer to my question!</a>
                </nav>
            </div>
            <div class="col-lg-9">

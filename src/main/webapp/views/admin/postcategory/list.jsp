        ...
        <div class="card adaptable-card">
            <div class="card-body">
                <div class="lg:flex items-center justify-between mb-4">
                    <h3 class="mb-4 lg:mb-0">Post Categories</h3>
                </div>
                <div class="flex-wrap inline-flex xl:flex items-center gap-2 mb-3">
                    <a class="btn btn-default btn-solid mr-2" href="${contextPath}/admin/postcategory/add">
                ...
                <div class="overflow-x-auto">
                    <table id="product-list-data-table"
                        ...
                        <tbody>
                        <c:forEach var="pc" items="${postcategories}">
                            <tr>
                                <td><span>${pc.id}</span></td>
                                <td>
                                    <div class="flex items-center">
                                        <span class="ml-2 rtl:mr-2 font-semibold">${pc.name}</span>
                                    </div>
                                </td>
                                <td>
                                    <c:choose>
                                ...
                                <td><img src="${contextPath}/resources/images/${pc.image}" width="100" alt=""/></td>
                                <td>
                                    <div class="flex justify-end text-lg">
                                        <a class="cursor-pointer p-2 hover:text-indigo-600"
                                           href="${contextPath}/admin/postcategory/edit/${pc.id}">
                                        ...
                                        <a onclick="return confirm('Bạn có muốn xóa không?')"
                                                ...
                                                href="${contextPath}/admin/category/delete/${pc.id}">
                                        <svg stroke="currentColor" fill="none" stroke-width="2"
                                             viewBox="0 0 24 24" aria-hidden="true" height="1em"
                                             width="1em" xmlns="http://www.w3.org/2000/svg">

...
<div
    ...
    <div class="container mx-auto">
        <h3 class="mb-4">Edit Post Category</h3>
        <f:form action="${contextPath}/admin/postcategory/update" method="post" modelAttribute="postcategory" enctype="multipart/form-data">
            <div class="form-container vertical">
                        ...
                        <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                            <div class="card-body">
                                ...
                                <div class="form-item vertical">
                                    <label class="form-label mb-2">Post Category Id</label>
                                    <div>
                                        <f:hidden class="input" path="id" />
                                        <label class="form-label mb-2">${postcategory.id}</label>
                                    </div>
                                </div>
                                <div class="form-item vertical">
                                    <label class="form-label mb-2">Post Category Name</label>
                                    <div>
                ...
                <div class="lg:col-span-1">
                    <div class="card adaptable-card mb-4">
                        <div class="card-body">
                            <h5>Post Category Image</h5>
                            <p class="mb-6">Add or change image for the post category</p>
                            <div class="form-item vertical">
                                <div>
                                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                        <div class="group relative rounded border p-2 flex">
                                            <img class="rounded max-h-[140px] max-w-full" src="${contextPath}/resources/images/${postcategory.image}" id="preview">

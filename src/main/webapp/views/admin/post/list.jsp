        ...
        <div class="card adaptable-card">
            <div class="card-body">
                <div class="lg:flex items-center justify-between mb-4">
                    <h3 class="mb-4 lg:mb-0">Posts</h3>
                </div>
                <div class="flex-wrap inline-flex xl:flex items-center gap-2 mb-3">
                    <a class="btn btn-default btn-solid mr-2" href="${contextPath}/admin/post/add">
                ...
                <div class="overflow-x-auto">
                    <table   class="table-default table-hover data-table">
                        ...
                        <tbody>
                        <c:forEach var="p" varStatus="loop" items="${posts.content}" >
                            <tr>
                                <td>${loop.count}</td>
                                <td>
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-2 rtl:mr-2 font-semibold">${p.name}</span>
                                    </div>
                                </td>
                                <td><span class="capitalize">${p.postCategory.name}</span></td>

                                <td><span class="capitalize">${p.description}</span></td>

                                <td>
                                    <div class="flex justify-end text-lg">
                                        <a class="cursor-pointer p-2 hover:text-indigo-600" href="${contextPath}/admin/post/edit/${p.id}">
                                        ...
                                        <a class="cursor-pointer p-2 hover:text-red-500" href="${contextPath}/admin/post/delete/${p.id}" > <svg
                        ...
                        <c:choose>
                            <c:when test="${not posts.first}">
                                 <span class="pagination-pager pagination-pager-prev">
                                     <a href="?page=${posts.number - 1}&size=${posts.size}">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="pagination-pager">
                                        <a href="?page=${status.index}&size=${posts.size}">
                                                ${status.index + 1}
                                        </a>
                                    </li>
                                </c:otherwise>

...
<div
    ...
    <div class="container mx-auto">
        ...
        <f:form action="${contextPath}/admin/post/update" method="post" enctype="multipart/form-data" modelAttribute="post">
                        ...
                        <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                            <div class="card-body">
                                ...
                                <div class="form-item vertical">
                                    <label class="form-label mb-2">Post Id</label>
                                    <div>
                                        ...
                                        <div
                                            ...
                                            <div class="group relative rounded border p-2 flex">
                                                <img class="rounded max-h-[140px] max-w-full"
                                                     src="${contextPath}/resources/images/${post.image}" alt="image-1" id="preview">

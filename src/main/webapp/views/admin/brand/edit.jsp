...
<div
    ...
    <div class="container mx-auto">
        ...
        <f:form action="${contextPath}/admin/brand/update" method="post" modelAttribute="brand" enctype="multipart/form-data">
            <div class="form-container vertical">
                    ...
                    <div class="lg:col-span-2">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-6">Section to config basic brand information</p>
                                <div class="form-item vertical">
                                    <label class="form-label mb-2">Brand Id</label>
                                    <div>
                                ...
                                <div class="form-item vertical">
                                    <label class="form-label mb-2">Brand Name</label>
                                    <div>
                ...
                <div class="lg:col-span-1">
                    <div class="card adaptable-card mb-4">
                        <div class="card-body">
                            <h5>Brand Image</h5>
                            <p class="mb-6">Add or change image for the brand</p>
                            <div class="form-item vertical">
                                <div>
                                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                        <div class="group relative rounded border p-2 flex">
                                            <img class="rounded max-h-[140px] max-w-full" src="${contextPath}/resources/images/${brand.image}" id="preview">
